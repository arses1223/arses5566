...
<style>
:root{--ars-bg:#050814;--ars-panel:rgba(10,16,35,.78);--ars-panel2:rgba(13,20,43,.9);--ars-blue:#36c9ff;--ars-purple:#9b5cff;--ars-pink:#ff4fd8;--ars-border:rgba(93,164,255,.22);--ars-text:#eef5ff;--ars-muted:#91a4c7;--ars-glow:0 0 28px rgba(54,201,255,.12),0 0 45px rgba(155,92,255,.08)}
html,body{background:radial-gradient(circle at 15% 10%,rgba(54,201,255,.12),transparent 28%),radial-gradient(circle at 85% 20%,rgba(155,92,255,.13),transparent 30%),linear-gradient(135deg,#030611,#080d20 48%,#0b0920)!important;color:var(--ars-text)!important}
body:before{content:"";position:fixed;inset:0;pointer-events:none;background-image:linear-gradient(rgba(54,201,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(155,92,255,.025) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,black,transparent 90%);z-index:0}
header,.topbar,.navbar,.sidebar,.panel,.card,.box,.modal,.table-wrap,.stat,.section,.dev-card{background:var(--ars-panel)!important;border-color:var(--ars-border)!important;box-shadow:var(--ars-glow)!important;backdrop-filter:blur(16px)}
button,.btn,.action-btn{border-radius:12px!important;border:1px solid rgba(54,201,255,.3)!important;background:linear-gradient(135deg,rgba(54,201,255,.14),rgba(155,92,255,.14))!important;color:#f5fbff!important;box-shadow:0 0 18px rgba(54,201,255,.08)!important}
button:hover,.btn:hover,.action-btn:hover{border-color:rgba(255,79,216,.6)!important;box-shadow:0 0 24px rgba(255,79,216,.16)!important;transform:translateY(-1px)}
input,select,textarea{background:rgba(4,9,23,.72)!important;border-color:rgba(93,164,255,.25)!important;color:#eef5ff!important;border-radius:10px!important}
.logo-name,.brand-name,.brand-sub,.mob-title{color:#fff!important;text-shadow:0 0 16px rgba(54,201,255,.5)}
.logo-name,.brand-name{background:linear-gradient(90deg,var(--ars-blue),var(--ars-purple),var(--ars-pink));-webkit-background-clip:text;background-clip:text;color:transparent!important}
.bar{background:linear-gradient(180deg,var(--ars-blue),var(--ars-purple),var(--ars-pink))!important;box-shadow:0 0 16px rgba(54,201,255,.6)!important}
a{color:#70d8ff!important}.mono{color:#9ec8ff!important}
.badge,.status,.pill{border-color:rgba(54,201,255,.3)!important;background:rgba(54,201,255,.08)!important}
@media(max-width:900px){.sidebar{background:rgba(5,8,20,.96)!important}}
</style>
<style>
    ...
    <div>
      <section class="card">
        <div class="card-head stg">
          <div class="logo"><img src="https://yt3.googleusercontent.com/vA6bYj1V386YmibpWRNFJtsRRqwfY_U9wnb7gmW90eRVXyNB7gAfjj1XPs5UX0cdKdQprrI=s160-c-k-c0x00ffffff-no-rj" alt="Arses"></div>
          <div>
            <div class="brand-name">Arses</div>
            <div class="brand-sub">Arses Panel</div>
          </div>
        ...
        <div class="card-foot stg">
          ...
          <a href="" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i></a>
        </div>
      </section>
...
<aside class="side-panel" id="panel" aria-hidden="true">
  ...
  <div class="panel-head"><span class="bar"></span><span class="mono">ARSES PANEL · CONTROL PLANE</span></div>
...
<div class="modal-bg" id="modal-support-dev" style="z-index:9999">
  <div class="modal-v2" style="max-width:440px">
    ...
    <div class="modal-v2-body">
      <div class="sdev-grid">
        <a href="" target="_blank" rel="noopener" class="sdev-card">
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">Arses Panel</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">Arses</div><div class="logo-sub">Arses Panel · v9.2</div></div>
  </div>
  <div class="nav-wrap">
  ...
  <div class="sb-foot">
    ...
    <a class="tg-btn" href="" target="_blank" rel="noopener"><i class="ti ti-brand-telegram"></i> </a>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Arses Arses Panel v9.2 · Railway · 2025</span>
    <a class="df-link" href="" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/CodeBoxo</a>
  </div>
</section>
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      ...
      <div><div class="brand-name">Arses</div><div class="brand-sub">Arses Panel · v9.2</div></div>
    </div>
    <div class="top-actions">
      <button class="icon-btn" id="theme-toggle" onclick="toggleTheme()" title="تغییر تم"><i class="ti ti-sun" id="theme-icon"></i></button>
      <a class="icon-btn" href="" target="_blank" title="کانال تلگرام"><i class="ti ti-brand-telegram"></i></a>
    </div>
  </div>
  <div id="root">
    <div class="empty-state"><i class="ti ti-loader-2" style="animation:spin 1s linear infinite"></i>در حال بارگذاری...</div>
  </div>
  <div class="footer">کانال رسمی: <a href="" target="_blank"></a> · Arses Panel v9.2</div>
</div>
<script>
